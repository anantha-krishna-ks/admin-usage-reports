        ...
        <Card className="border-primary/20 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent">
          <CardContent className="flex items-center gap-4 p-5">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">across the network</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="flex items-center gap-4 p-5">
            ...
            <div className="flex-1">
              ...
              <p className="text-2xl font-semibold tabular-nums">{totalCreated.toLocaleString()}</p>
              <p className="text-xs text-muted-foreground mt-0.5">items this month</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="flex items-center gap-4 p-5">
            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-chart-3/15 text-chart-3">
              <School className="h-6 w-6" />
            </div>
            <div className="flex-1">
              <p className="text-xs uppercase tracking-wide text-muted-foreground">Avg / School</p>
              <p className="text-2xl font-semibold tabular-nums">{Math.round(totalCreated / totalSchools).toLocaleString()}</p>
              <p className="text-xs text-muted-foreground mt-0.5">items per school</p>
            </div>
          </CardContent>
        </Card>
      </div>
